                    ...
                    ElevatedButton(
                        ...
                        onPressed: () async {
                          if(city.text.isEmpty){
                            showSnackbar(context, Colors.red, 'Укажите город.');
                          } else if(age.text.isEmpty){
                            showSnackbar(context, Colors.red, 'Укажите возраст.');
                          } else if(_image == null){
                            showSnackbar(context, Colors.red, 'Добавьте фото.');
                          } else if(hobbi.text.isEmpty){
                            showSnackbar(context, Colors.red, 'Укажите хобби.');
                          } else if(about.text.isEmpty){
                            showSnackbar(context, Colors.red, 'Укажите о себе.');
                          } else if(rost.text.isEmpty){
                            showSnackbar(context, Colors.red, 'Укажите рост.');
                          } else if(pol == null){
                            showSnackbar(context, Colors.red, 'Укажите пол.');
                          } else if(Deti == null){
                            showSnackbar(context, Colors.red, 'Укажите количество детей.');
                          } else if(!Is18){
